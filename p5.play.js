...
/**
   ...
   * or all the sprites that "kill" the plane.
   *
 ...
 *     var plane_frames = loadJSON('assets/tiles.json');
 *     plane_sprite_sheet = loadSpriteSheet('assets/plane_spritesheet.png', plane_frames);
 *
 * @class SpriteSheet
 * @constructor
